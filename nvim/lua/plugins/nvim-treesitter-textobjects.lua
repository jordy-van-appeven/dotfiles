        ...
        nvim_next = {
            ...
            textobjects = {
                ...
                swap = {
                    ...
                    swap_previous = {
                        ["<leader>pa"] = { query = "@parameter.inner", desc = "Swap parameters/argument with prevous" },
                        ["<leader>p:"] = { query = "@property.outer", desc = "Swap object property with prevous" },
                        ["<leader>pm"] = { query = "@function.outer", desc = "Swap function with previousous" },
                    },
                },
                move = {
